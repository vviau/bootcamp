app.controller('angularjsoldCtrl', ['$scope', '$rootScope', '$interval', '$timeout', '$tm1Ui', '$stateParams', '$http', '$ngBootbox', '$location',
...
$scope.options = {
    ...
    $scope.setTitleStyle = function (value) {
        $scope.options.changeColor =!  $scope.options.changeColor;
        if (value) {
            // Set the URL parameter
